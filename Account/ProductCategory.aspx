<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductCategory.aspx.cs" Inherits="Account_category" %>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-content">
                                ...
                                <li><a runat="server" href="~/Home.aspx">Log out</a></li>
        ...
        <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="productid">
                    ...
                    <div class="item  col-xs-4 col-lg-4 grid-group-item list-group-item">    
                      ...
                      <asp:Image ID="image" runat="server"
                        ...
                        <div style="position:absolute;right:-310px;float:right;top:150px">
                            ...
                            <asp:Button runat="server" class="btn btn-success btn-lg"  Text="View" OnClick="Unnamed_Click1"  CommandArgument='<%#Eval("productid") %>'></asp:Button>
            ...
            <EmptyDataTemplate>
                <table runat="server" style="">
                    <tr>
                        <td>Products to be released soon</td>
                    </tr>
                </table>
            </EmptyDataTemplate>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$  ConnectionStrings:1738044ConnectionString5 %>" SelectCommand="SELECT [productprice], [productimage], [productid] FROM [products] WHERE ([productcateg] = @productcateg)">
            <SelectParameters>
                <asp:SessionParameter Name="productcateg" SessionField="category" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </form>
</body>
